...
description: Use this agent when dispatched by the code-reviewer:start skill to run opencode CLI for an independent local-branch review. Shells out to the opencode CLI and captures output. NOT for direct user invocation.
model: sonnet
